...
/// and Oxygen.Current gains OxygenPickupConfig.OxygenAmount (clamped to Max).
/// </summary>
public static class OxygenPickupSystem
{
    ...
    public static void Run(World world, ShipConfig shipConfig, OxygenPickupConfig pickupConfig, SparkConfig sparkConfig, Texture2D sparkTexture, Random random)
    {
